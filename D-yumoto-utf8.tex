...
%また，複数のシステムを統合するといった大規模な開発の事例では，8ヶ月の間に約5000人がテストに投入されたという事例もある[4]．
...
% この課題を解決するため， テスト開発のためのルールとなるテスト分析手法を提案している．
% このテスト分析手法は，ブラックボックステストのための手法であり，AUTとフォールトの知識をベースにしたテストカテゴリを使う [6]．
% 本論文では，このテストカテゴリを使うテスト分析手法の効果について述べる．
...
% section{はじめに}
%ソフトウェア開発の中の品質を確保する主要な工程として,ソフトウェアテスティングがある．このことから，ソフトウェア開発の品質，納期と費用のバランスを適切に保つためには，ソフトウェアテスティングを適切な工数で十分に行う必要があるといえる．
